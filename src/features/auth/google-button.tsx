...
function GoogleGlyph() {
  return (
    <svg viewBox="0 0 48 48" className="size-[18px]" aria-hidden>
      ...
      <path fill="#fbbc04" d="M11.7 28.2c-.4-1.3-.7-2.7-.7-4.2s.3-2.9.7-4.2v-5.7H4.4C2.9 17.1 2 20.4 2 24s.9 6.9 2.4 9.9l7.3-5.7z" />
      <path fill="#ea4335" d="M24 10.7c3.2 0 6.1 1.1 8.4 3.3l6.3-6.3C34.9 4.2 29.9 2 24 2 15.4 2 8 6.9 4.4 14.1l7.3 5.7c1.7-5.2 6.6-9.1 12.3-9.1z" />
    </svg>
  );
}
  ...
  return (
    <form action={signInWithGoogle}>
      ...
      <Button
        ...
        disabled={!enabled}
        title={enabled ? undefined : "Google sign-in isn't configured on this server"}
      >
        <GoogleGlyph />

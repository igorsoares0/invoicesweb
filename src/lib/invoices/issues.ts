 ...
 */
export function findIssueProblems(invoice: IssueCheckInput): IssueProblem[] {
  ...
  if (invoice.dueDate < invoice.issueDate) {
    problems.push({
      path: "dueDate",
      summary: "Due date is before the issue date",
      fix: `${formatShortDate(invoice.dueDate)} comes before ${formatShortDate(invoice.issueDate)}`,

...
import { ESTIMATE_TOKEN_PATTERN, generatePublicToken, PUBLIC_TOKEN_PATTERN } from "./public-token";
...
describe("generatePublicToken", () => {
  ...
  it("marks estimate links with est_", () => {
    expect(generatePublicToken("est")).toMatch(ESTIMATE_TOKEN_PATTERN);
  });
